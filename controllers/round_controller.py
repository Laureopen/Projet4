import random
# Importation des contrôleurs et des vues nécessaires pour gérer les matchs, les joueurs, les tours et les tournois.
...
class RoundController:
    ...
    def __init__(self, tournament, players, round_num, start_date=None, end_date=None):
        # Initialisation des contrôleurs et des vues nécessaires.
        self.match_controller = MatchController()
        self.player_controller = PlayerController()
        self.round_view = RoundView()
        self.tournament_view = TournamentView()

        # Chargement des joueurs via le PlayerController.
    ...
    def create_round(self):
        ...
        # Mélange des joueurs pour le premier tour, sinon tri par score.
        ...
        # Boucle pour créer les matchs du tour.
        ...
        # Création des matchs pour le tour actuel.
    ...
    def permutate_last_players(self, match_players, match_idx, remaining_players):
        # Permutation des derniers joueurs si nécessaire pour éviter les répétitions de matchs.
    ...
    def play_matchs(self, player1, opponent, current_round, match_idx):
        # Création d'un match entre deux joueurs et ajout au tour actuel.
    ...
    def change_adversary(self, match_players, previous_match_idx, player1, remaining_players, last=False):
        # Changement d'adversaire pour éviter les répétitions de matchs.
    ...
    def start_round(self, round):
        # Démarrage d'un tour en affichant les matchs et en attendant les résultats.
        ...
        for idx, match in enumerate(round.matches):
            ...
            if results not in ('0', '1', '2'):
                ...
                # Mise à jour des scores et des adversaires rencontrés.
        ...
        # Récupération et tri des joueurs du tournoi par score.
        tournament_players = \
